<h3>Overview</h3>
<p>
	List optimized for use with the TimeMachineList class.
</p>

<h3>Using the TimeMachineList Component</h3>
<p>
	The list is navigated using typical Spark List methods.  The major change 
	is that instead of scrolling through the list via vertical or horizontal 
	scroll, the list is scrolled along the z axis, or the "zScrollPosition" 
	property.  
</p>
<p>
...
<h3>Example</h3>
<p>
	See the TimeMachineList demo application for example code.
</p>
